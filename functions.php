	...
	function on_reading_setup() {
		...
		register_nav_menus(
			array(
				...
				'combined' => esc_html__( 'Combined', 'on-reading'),
			)
		);
...
// 	wp_enqueue_style ('on-reading-theme-fonts', 'https://fonts.googleapis.com/css2?family=Alegreya+SC&family=Norican&display=swap', array(), ON_READING_VERSION);
	...
	wp_enqueue_script( 'masonry-script', 'https://cdn.jsdelivr.net/npm/masonry-layout@4.2.2/dist/masonry.pkgd.min.js', array(), ON_READING_VERSION, true );
